...
const SlideList = [
  {
    ...
    category: 'Freelance Software Developer',
    title: 'I design and build beautiful and reliable software.',
    description: '',
    buttonText: '',
    buttonLink: '',
  },
                ...
                <div className='row'>
                  <div className='col-lg-12'>
                    <div className={`inner ${value.textPosition}`}>
                      ...
                      {value.title ? <h1 className='title' dangerouslySetInnerHTML={{ __html: value.title }} /> : ''}
